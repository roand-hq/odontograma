...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    k.Fragment = T, k.jsx = function(e, o, l, p, j) {
...
var U;
function se() {
  return U || (U = 1, process.env.NODE_ENV === "production" ? S.exports = te() : S.exports = ie()), S.exports;
}
var r = se();
const de = () => {
  const c = [
