 ...
 */var M;function J(){if(M)return R;M=1;var c=Symbol.for("react.transitional.element"),u=Symbol.for("react.fragment");function f(s,n,i){var m=null;if(i!==void 0&&(m=""+i),n.key!==void 0&&(m=""+n.key),"key"in n){i={};for(var t in n)t!=="key"&&(i[t]=n[t])}else i=n;return n=i.ref,{$$typeof:c,type:s,key:m,ref:n!==void 0?n:null,props:i}}return R.Fragment=u,R.jsx=f,R.jsxs=f,R}var S={};/**
 * @license React
...
React keys must be passed directly to JSX without using spread:
  ...
  margin-top: 64px;
      ...
      `}),r.jsxs("div",{className:"odontograma-container",children:[r.jsx(B,{abierto:m,onClick:()=>t(!m),colorSeleccionado:d,setColorSeleccionado:g,colores:f,handleExport:_}),r.jsx("div",{className:"odontograma-seccion",children:r.jsxs("div",{className:"odontograma-grid",children:[r.jsxs("div",{className:"cuadrante cuadrante-1",children:[r.jsx("div",{className:"numero-cuadrante",children:"1"}),r.jsx("div",{className:"dientes-fila",children:["8","7","6","5","4","3","2","1"].map(a=>r.jsx(E,{numero:a,cuadrante:"1",colorSeleccionado:d,coloresSecciones:s[`1${a}`],cambiarColorSeccion:n},`1-${a}`))}),r.jsx("div",{className:"dientes-fila-infantiles-izq",children:["5","4","3","2","1"].map(a=>r.jsx(E,{numero:a,cuadrante:"5",colorSeleccionado:d,coloresSecciones:s[`5${a}`],cambiarColorSeccion:n},`5-${a}`))})]}),r.jsxs("div",{className:"cuadrante cuadrante-2",children:[r.jsx("div",{className:"numero-cuadrante",children:"2"}),r.jsx("div",{className:"dientes-fila",children:["1","2","3","4","5","6","7","8"].map(a=>r.jsx(E,{numero:a,cuadrante:"2",colorSeleccionado:d,coloresSecciones:s[`2${a}`],cambiarColorSeccion:n},`2-${a}`))}),r.jsx("div",{className:"dientes-fila-infantiles-der",children:["1","2","3","4","5"].map(a=>r.jsx(E,{numero:a,cuadrante:"6",colorSeleccionado:d,coloresSecciones:s[`6${a}`],cambiarColorSeccion:n},`6-${a}`))})]}),r.jsxs("div",{className:"cuadrante cuadrante-4",children:[r.jsx("div",{className:"dientes-fila-infantiles-izq",children:["5","4","3","2","1"].map(a=>r.jsx(E,{numero:a,cuadrante:"8",colorSeleccionado:d,coloresSecciones:s[`8${a}`],cambiarColorSeccion:n},`8-${a}`))}),r.jsx("div",{className:"dientes-fila",children:["8","7","6","5","4","3","2","1"].map(a=>r.jsx(E,{numero:a,cuadrante:"4",colorSeleccionado:d,coloresSecciones:s[`4${a}`],cambiarColorSeccion:n},`4-${a}`))}),r.jsx("div",{className:"numero-cuadrante",children:"4"})]}),r.jsxs("div",{className:"cuadrante cuadrante-3",children:[r.jsx("div",{className:"dientes-fila-infantiles-der",children:["1","2","3","4","5"].map(a=>r.jsx(E,{numero:a,cuadrante:"7",colorSeleccionado:d,coloresSecciones:s[`7${a}`],cambiarColorSeccion:n},`7-${a}`))}),r.jsx("div",{className:"dientes-fila",children:["1","2","3","4","5","6","7","8"].map(a=>r.jsx(E,{numero:a,cuadrante:"3",colorSeleccionado:d,coloresSecciones:s[`3${a}`],cambiarColorSeccion:n},`3-${a}`))}),r.jsx("div",{className:"numero-cuadrante",children:"3"})]}),r.jsx("div",{className:"linea-vertical"}),r.jsx("div",{className:"linea-horizontal"})]})}),r.jsxs("div",{className:"leyenda-container",children:[r.jsx("h3",{className:"leyenda-titulo",children:"Leyenda de Tratamientos"}),r.jsx("div",{className:"leyenda-grid",children:f.map(a=>r.jsxs("div",{className:"leyenda-item",children:[r.jsx("div",{className:"leyenda-color",style:{backgroundColor:a.valor}}),r.jsx("span",{className:"leyenda-texto",children:a.nombre})]},a.valor))})]})]})]})}});
